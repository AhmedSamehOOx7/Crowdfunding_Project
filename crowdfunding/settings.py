...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-3$wjecx7(by0awufpzhv0932p-ku7m0@pwz+ll4b7-u6sy@h2+')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'projects.context_processors.categories_processor',
            ],
        },
    },
]
